...
<body class="container" style="min-width: 1024px;">
	...
	<div class="row" >
		...
		<form id="pesquisa" name="pesquisa" method="post" 
			  action="/easports/ControleProduto?acao=pesquisar" style="margin-left: 700px">
				  
			<input type="submit" class="btn btn-sm" value="Pesquisar" style="background-color: #cacaff; 
		...
		<c:forEach items="${lista}" var="produto">
			...
			<div class="col-md-3" style="width: 290">
				<div class="panel panel-success">
					...
					<span class="glyphicon glyphicon-credit-card" style="width: 16px;font-size: 12px;margin-left: -6px;"></span>
						<b>Código: ${produto.codigo}</b>
					</div>
					<div class="panel-body text-center">
						<img src="img/${produto.imagem}" width="150" height="135" />
						<hr/>
						...
						<a href="/easports/ControleProduto?acao=adicionarProduto&id=${produto.idProduto}"
								...
								color: black; margin-top: 20px;border-color: black">
								
								<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span> Adicionar
						...
						<a href="/easports/ControleProduto?acao=detalhesProduto&id=${produto.idProduto}"
								...
								color: black; margin-top: 20px; margin-left: -215px;border-color: black">

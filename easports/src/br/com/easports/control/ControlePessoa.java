...
public class ControlePessoa extends HttpServlet {
	...
	// método responsável por coletar as informações dos botões submit, nas páginas JSP (Java Server Pages)
	...
	protected void execute(HttpServletRequest request, HttpServletResponse response)
		...
		// if/else responsável por comparar a ação trazida através do formulário com as opções possíveis 
		// de serem executadas pela página. Ex: cadastrar pessoa física, consultar fornecedores, 
		// cadastrar produtos etc...
		
		if (acao != null) {

			// Se o valor da ação recebida pelo formulário for "cadastrarpf", execute o bloco abaixo:
			
			if (acao.equalsIgnoreCase("cadastrarpf")) {

				try {

					// Instanciando um novo Endereço para receber os parâmetros passados pelo usuário 
					// através da JSP
					
					Endereco endereco = new Endereco();

					// Coletando cada parâmetro da página através do "name" do formulário, utilizando 
					// o request.getParameter() e atribuindo à entidade Endereco através dos setters
					...
					// Utilizando o método que recebe como parâmetro um objeto endereço, grava o 
					// mesmo no banco e retorna seu id, criado automaticamente pelo próprio SQL
					
					int idEndereço = enderecoDao.insertReturnID(endereco);

					// Instanciando um novo ClientePF para receber os parâmetros passados pelo usuário 
					// através da JSP
					
					ClientePF clientePf = new ClientePF();

					// Coletando cada parâmetro da página através do "name" do formulário, utilizando 
					// o request.getParameter() e atribuindo à entidade ClientePF através dos setters
					...
					// Instanciando a classe responsável por gravar, alterar e excluir Clientes no banco
					
					ClientePFDAO clientePfDao = new ClientePFDAO();

					// Utilizando o método responsável por receber como parâmetro um ClientePF e um id de 
					// Endereço, gravar o Cliente no banco e atribuir a ele este Endereço, através da coluna 
			...
			// Se o valor da ação recebida pelo formulário for "consultarpf", execute o bloco abaixo:

			else if (acao.equalsIgnoreCase("consultarpf")) {

				try {

					// Coletando da página o parâmetro "cpf", através do "name" do formulário, utilizando 
					...
					// Utilizando o método que recebe como parâmetro um número de cpf e retorna os dados 
					...
					// Redirecionando novamente para a mesma página de consulta de clientes
			...
			// Se o valor da ação recebida pelo formulário for "cadastrarFornecedor", execute o bloco abaixo:
				...
				try {
					...
					// Utilizando os Setters da classe Endereco para passar valores aos seus atributos
					...
					// Utilizando os Setters da classe Fornecedor para passar valores aos seus atributos
					...
					// Instanciando a classe responsável por gravar, alterar e excluir Fornecedores no banco
					
					FornecedorDAO fornecedorDao = new FornecedorDAO();
					
					// Utilizando o método responsável por receber como parâmetro um Fornecedor e um id de 
					// Endereço, gravar o Fornecedor no banco e atribuir a ele este Endereço, através da coluna 
					...
					// Redirecionando novamente para a mesma página de cadastro de fornecedores
			...
			// Se o valor da ação recebida pelo formulário for "consultarFornecedor", execute o bloco abaixo:
			
			else if (acao.equalsIgnoreCase("consultarFornecedor")) {

				try {

					// Coletando da página o parâmetro "cnpj", através do "name" do formulário, utilizando 
					// o método request.getParameter()
					...
					// Utilizando o método que recebe como parâmetro um número de cnpj e retorna os dados 
					...
					// Utilizando o método que recebe como parâmetro o id de um Endereco e retorna os dados 
					// do mesmo gravados no banco. Para isso, utilizamos o getEndereco do fornecedor para encontrar 
					// seu endereço e, por fim, o método getId do endereço, para encontrar seu id
					...
					// Retornando para a página JSP o objeto fornecedor e atribuindo a ele o nome "fornecedor"
					...
					// Redirecionando novamente para a mesma página de consulta de fornecedores
